...
#define ADCDAT0 		(*((volatile unsigned int *)(0x5800000C)))
#define ADCDAT1 		(*((volatile unsigned int *)(0x58000010)))
#define ADCUPDN 		(*((volatile unsigned int *)(0x58000014)))
...
#define NFCMD 		(*((volatile unsigned char *)(0x4E000008)))	//NFCMMD
